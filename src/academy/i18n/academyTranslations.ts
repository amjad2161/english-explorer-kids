...
export const academyTranslations: Record<string, Tri> = {
  ...
  "academy.hud.startActivity": T("Start activity", "התחילו פעילות", "ابدأ النشاط"),
  "academy.game.plaza": T("Academy Plaza", "רחבת האקדמיה", "ساحة الأكاديمية"),
  "academy.game.citrus": T("Citrus Market Sort", "מיון שוק ההדרים", "فرز سوق الحمضيات"),
  "academy.game.logic": T("Pixel Path Lab", "מעבדת מסלול פיקסל", "مختبر مسار بيكسل"),
  "academy.game.anatomy": T("Friendly Body Explorer", "חוקר הגוף הידידותי", "مستكشف الجسم الودود"),
  "academy.game.science": T("Science Garden Grow", "גן המדע הצומח", "نمو حديقة العلوم"),
  "academy.game.animals": T("Animal Habitats", "בתי גידול לחיות", "بيئات الحيوانات"),
  "academy.game.music": T("Fruit Rhythm Stage", "במת קצב הפירות", "منصة إيقاع الفاكهة"),
  "academy.game.feelings": T("Feelings & Empathy", "רגשות ואמפתיה", "المشاعر والتعاطف"),
  "academy.game.language": T("Word Constellation", "קונסטלציית מילים", "كوكبة الكلمات"),
  "academy.game.finale": T("Graduation Locks", "מנעולי הסיום", "أقفال التخرج"),
  "academy.hud.act": T("Act {n}", "מערכה {n}", "الفصل {n}"),
  "academy.hud.interactionsCount": T("{done}/12 interactions", "{done}/12 אינטראקציות", "{done}/12 تفاعلات"),
  "academy.webglUnavailable": T(
    "WebGL is not available on this device.",
    "WebGL אינו זמין במכשיר זה.",
    "WebGL غير متاح على هذا الجهاز.",
  ),
  "academy.promo.description": T(
  ...
  "academy.nav": T("Academy", "אקדמיה", "الأكاديمية"),
  "academy.game.roomSort.instruction": T(
    "Tap a toy, then tap its matching box",
    "לחצו על צעצוע ואז על התיבה המתאימה",
    "اضغط على لعبة ثم على الصندوق المطابق",
  ),
  "academy.game.kitchen.instruction": T("Tap only safe items", "לחצו רק על פריטים בטוחים", "اضغط فقط على العناصر الآمنة"),
  "academy.game.street.instruction": T("Cross only on green", "חצו רק בירוק", "اعبر فقط عند الأخضر"),
  "academy.game.street.cross": T("Cross", "חצו", "اعبر"),
  "academy.game.citrus.instruction": T("Add slices to make a whole orange (4 slices)", "הוסיפו פרוסות לתפוז שלם (4 פרוסות)", "أضف شرائح لتكوين برتقالة كاملة (4 شرائح)"),
  "academy.game.pixel.instruction": T("Program Pixel: {path}", "תכנתו את פיקסל: {path}", "برمج بيكسل: {path}"),
  "academy.game.pixel.step": T("Step {step}/{total}", "שלב {step}/{total}", "الخطوة {step}/{total}"),
  "academy.game.heart.exercise": T("Exercise!", "פעילות גופנית!", "تمرين!"),
  "academy.game.science.instruction": T(
    "Water and sun the plant until it blooms",
    "השקו והאירו את הצמח עד שהוא פורח",
    "اسقِ النبتة وأضئها حتى تزهر",
  ),
  "academy.game.science.water": T("Water", "מים", "ماء"),
  "academy.game.science.sun": T("Sun", "שמש", "شمس"),
  "academy.game.science.waterBtn": T("💧 Water ({count})", "💧 מים ({count})", "💧 ماء ({count})"),
  "academy.game.science.sunBtn": T("☀️ Sun ({count})", "☀️ שמש ({count})", "☀️ شمس ({count})"),
  "academy.game.animals.instruction": T(
    "Tap an animal, then its habitat",
    "לחצו על חיה ואז על בית הגידול שלה",
    "اضغط على حيوان ثم على بيئته",
  ),
  "academy.game.word.instruction": T(
    "Spell STAR using the glowing letters",
    "איירו את המילה STAR באותיות הזוהרות",
    "تهجَّ كلمة STAR بالحروف المضيئة",
  ),
  "academy.game.rhythm.instruction": T("Repeat: {pattern}", "חזרו: {pattern}", "كرر: {pattern}"),
  "academy.game.empathy.instruction": T("Sara lost her sketchbook. What do you do?", "שרה איבדה את המחברת. מה תעשו?", "فقدت سارة دفتر الرسم. ماذا تفعل؟"),
  "academy.game.empathy.help": T("Help her search", "עזרו לה לחפש", "ساعدها في البحث"),
  "academy.game.empathy.ask": T("Ask how she feels", "שאלו איך היא מרגישה", "اسألها كيف تشعر"),
  "academy.game.empathy.ignore": T("Ignore and play", "התעלמו ושחקו", "تجاهل والعب"),
  "academy.game.final.instruction": T("Solve 3 puzzles to unlock the gates", "פתרו 3 חידות לפתיחת השערים", "حل 3 ألغاز لفتح البوابات"),
  "academy.game.final.solve": T("Solve puzzle ({locks}/3)", "פתרו חידה ({locks}/3)", "حل اللغز ({locks}/3)"),
  "academy.game.final.q1": T("What is 1 + 2?", "כמה זה 1 + 2?", "كم يساوي 1 + 2؟"),
  "academy.game.final.q2": T("What is 2 + 3?", "כמה זה 2 + 3?", "كم يساوي 2 + 3؟"),
  "academy.game.final.q3": T("What is 3 + 5?", "כמה זה 3 + 5?", "كم يساوي 3 + 5؟"),
