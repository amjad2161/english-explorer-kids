...
const AppHeader = () => {
  ...
  const navItems = [
    ...
    { path: "/story", label: t("nav.story"), icon: "📖", mobileOnly: true },
    { path: "/learn", label: t("nav.learn"), icon: "🗺️", mobileOnly: true },
    { path: "/phonics", label: t("nav.phonics"), icon: "🔡", mobileOnly: true },
    { path: "/grammar", label: t("nav.grammar"), icon: "🏗️", mobileOnly: true },
    { path: "/tpr", label: t("nav.tpr"), icon: "🏃", mobileOnly: true },
