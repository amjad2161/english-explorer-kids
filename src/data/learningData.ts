...
export const wordCategories = [
  ...
  },
  {
    ...
    color: "sky" as const,
    words: [
      { english: "Head", hebrew: "ראש", emoji: "🗣️", category: "body" },
      ...
      { english: "Finger", hebrew: "אצבע", emoji: "☝️", category: "body" },
    ],
  },
  {
    name: "משפחה",
    ...
    color: "candy" as const,
    words: [
      { english: "Mother", hebrew: "אמא", emoji: "👩", category: "family" },
      { english: "Father", hebrew: "אבא", emoji: "👨", category: "family" },
      { english: "Sister", hebrew: "אחות", emoji: "👧", category: "family" },
      { english: "Brother", hebrew: "אח", emoji: "👦", category: "family" },
      { english: "Baby", hebrew: "תינוק", emoji: "👶", category: "family" },
      { english: "Grandmother", hebrew: "סבתא", emoji: "👵", category: "family" },
      { english: "Grandfather", hebrew: "סבא", emoji: "👴", category: "family" },
    ],
  },
  {
    name: "בית ספר",
    ...
    words: [
      { english: "Book", hebrew: "ספר", emoji: "📚", category: "school" },
      { english: "Pencil", hebrew: "עיפרון", emoji: "✏️", category: "school" },
      { english: "Teacher", hebrew: "מורה", emoji: "👩‍🏫", category: "school" },
      { english: "Student", hebrew: "תלמיד", emoji: "🧑‍🎓", category: "school" },
      { english: "Table", hebrew: "שולחן", emoji: "🪑", category: "school" },
      { english: "Bag", hebrew: "תיק", emoji: "🎒", category: "school" },
  ...
  },
  {
    ...
    words: [
      ...
      { english: "Chicken", hebrew: "עוף", emoji: "🍗", category: "food" },
      { english: "Water", hebrew: "מים", emoji: "💧", category: "food" },
