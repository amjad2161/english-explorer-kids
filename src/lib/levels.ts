...
export interface LevelStage {
  ...
  description: string;
  emoji: string;
  type: "alphabet" | "words" | "quiz" | "memory";
    ...
    stages: [
      {
        ...
        title: "אותיות A-I",
        titleEn: "Letters A-I",
        description: "למד את 9 האותיות הראשונות",
        emoji: "🔤",
        type: "alphabet",
        letterRange: [0, 8],
        starsToComplete: 5,
      },
      {
        ...
        title: "חיות",
        titleEn: "Animals",
        description: "למד שמות של חיות באנגלית",
        emoji: "🐾",
        type: "words",
        categoryIndices: [0],
        starsToComplete: 4,
      },
      {
        ...
        title: "צבעים",
        titleEn: "Colors",
        description: "למד את הצבעים באנגלית",
        emoji: "🎨",
        type: "words",
        categoryIndices: [1],
        starsToComplete: 4,
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        title: "מספרים",
        titleEn: "Numbers",
        description: "למד מספרים באנגלית",
        emoji: "🔢",
        type: "words",
        categoryIndices: [2],
        starsToComplete: 4,
      ...
      },
      {
        id: "2-4",
        title: "חידון רמה 1",
        titleEn: "Quiz Level 1",
        description: "בדוק מה למדת עד כה!",
        emoji: "🎯",
        type: "quiz",
        starsToComplete: 3,
      },
    ...
    stages: [
      {
        ...
        title: "אותיות S-Z",
        titleEn: "Letters S-Z",
        description: "השלם את כל האלפבית!",
        emoji: "🔤",
        type: "alphabet",
        letterRange: [18, 25],
        starsToComplete: 5,
      },
      {
        ...
        title: "חלקי גוף",
        titleEn: "Body Parts",
        description: "למד חלקי גוף באנגלית",
        emoji: "🦵",
        type: "words",
        categoryIndices: [4],
        starsToComplete: 4,
      ...
      },
      {
        ...
        description: "התאם מילים לתמונות!",
        emoji: "🧩",
        type: "memory",
        starsToComplete: 3,
      },
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        title: "אוכל",
        titleEn: "Food",
        description: "למד שמות של מאכלים",
        emoji: "🍕",
        type: "words",
        categoryIndices: [7],
        starsToComplete: 4,
      ...
      },
      {
        id: "4-4",
        title: "התאמה מאסטר",
        titleEn: "Master Match",
        description: "משחק התאמה מתקדם!",
        emoji: "🧩",
        type: "memory",
        starsToComplete: 3,
      },
