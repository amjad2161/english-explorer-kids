...
const AlphabetPage = () => {
  ...
  const handleLetterClick = (index: number) => {
    ...
    setTimeout(() => speakEnglish(letter.letter), 300);
  };
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-muted-foreground font-body">
            לחץ על אות כדי לשמוע איך היא נשמעת!
          </p>
          <div className="mt-3">
          ...
          {selectedLetter !== null && (
            ...
            >
              ...
              <p className="text-xl font-display text-muted-foreground mb-2">
                {alphabet[selectedLetter].hebrew}
              </p>
              ...
              <div className="bg-muted rounded-2xl p-4 mb-4">
                ...
                <p className="font-display text-2xl font-bold">
                  {alphabet[selectedLetter].word}
                </p>
                <p className="text-muted-foreground font-body">
                  {alphabet[selectedLetter].wordHebrew}
                </p>
              </div>
          ...
          {alphabet.map((item, index) => {
            ...
            return (
              <motion.button
                ...
                className={`letter-card aspect-square text-2xl font-bold relative ${colorClass} ${
