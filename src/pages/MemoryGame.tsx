...
const MemoryGame = () => {
  ...
  }, [flipped, matched, cards, isChecking, moves]);
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-muted-foreground font-body">
            מצא את הזוגות - התאם מילה באנגלית לתמונה!
          </p>
        </motion.div>
          ...
          {selectedCategory === null ? (
            ...
            >
              {wordCategories.map((cat, index) => (
                ...
                >
                  <div
                    className={`${categoryGradients[cat.color] || "gradient-primary"} w-20 h-20 rounded-2xl mx-auto mb-3 flex items-center justify-center`}
                  >
            ...
            >
              ...
              <h2 className="font-display text-3xl font-bold mb-3">!כל הכבוד</h2>
              <div className="mb-4">
                <StarRating earned={getStars()} total={3} size={36} />
              </div>
              <p className="font-display text-xl mb-2">
                סיימת ב-{moves} מהלכים!
              </p>
              <p className="text-muted-foreground font-body mb-6">
                {moves < 8 ? "!מדהים! זיכרון מושלם 🧠" : moves < 12 ? "!יפה מאוד 👏" : "!כל הכבוד, המשך לתרגל 💪"}
              </p>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                  <span className="font-display font-semibold text-sm bg-muted px-3 py-1.5 rounded-full">
                    🔄 {moves} מהלכים
                  </span>
                  <span className="font-display font-semibold text-sm bg-accent/20 text-accent-foreground px-3 py-1.5 rounded-full">
                    ✅ {matched.length / 2}/{cards.length / 2} זוגות
                  </span>
                </div>
              </div>
